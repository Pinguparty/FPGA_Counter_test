...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/Counter.srcs/sources_1/new/Counter.vhd"]"\
 "[file normalize "$origin_dir/Counter.srcs/constrs_1/new/Clock.xdc"]"\
 "[file normalize "$origin_dir/Counter.srcs/constrs_1/new/Board.xdc"]"\
 "[file normalize "$origin_dir/Counter_TB_behav.wcfg"]"\
  ...
  set files [list \
 "[file normalize "$origin_dir/Counter.srcs/SimpleCounterSim/imports/qr/Counter_TB.vhd"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set file "[file normalize "$origin_dir/Counter.srcs/constrs_1/new/Clock.xdc"]"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/Counter.srcs/constrs_1/new/Board.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
...
# Create 'SimpleCounterSim' fileset (if not found)
if {[string equal [get_filesets -quiet SimpleCounterSim] ""]} {
  create_fileset -simset SimpleCounterSim
}

# Set 'SimpleCounterSim' fileset object
set obj [get_filesets SimpleCounterSim]
set files [list \
 [file normalize "${origin_dir}/Counter.srcs/SimpleCounterSim/imports/qr/Counter_TB.vhd"] \
]
...
set added_files [add_files -fileset SimpleCounterSim $files]

# Set 'SimpleCounterSim' fileset file properties for remote files
set file "$origin_dir/Counter.srcs/SimpleCounterSim/imports/qr/Counter_TB.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets SimpleCounterSim] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "library" -value "work" -objects $file_obj


# Set 'SimpleCounterSim' fileset file properties for local files
# None

# Set 'SimpleCounterSim' fileset properties
set obj [get_filesets SimpleCounterSim]
set_property -name "top" -value "Counter_TB" -objects $obj
set_property -name "xsim.simulate.runtime" -value "320us" -objects $obj
